...
const AdminHeader = () => {
  ...
  return (
    ...
    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 me-5">
      ...
      <li class="nav-item">
        <Link to="/admin/event/category/add" class="nav-link active" aria-current="page">
      ...
      <li class="nav-item">
        <Link to="/admin/event/category/all"  class="nav-link active" aria-current="page">
      ...
      <li class="nav-item">
        <Link to="/admin/event/booking/all" class="nav-link active"  aria-current="page" >
      ...
      <li class="nav-item">
        <Link
          to=""  class="nav-link active"  aria-current="page" onClick={adminLogout}>
